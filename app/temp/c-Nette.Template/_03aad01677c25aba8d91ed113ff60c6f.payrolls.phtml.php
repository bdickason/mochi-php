<?php //netteCache[01]000239a:2:{s:4:"time";s:21:"0.75495500 1277160939";s:9:"callbacks";a:1:{i:0;a:3:{i:0;a:2:{i:0;s:5:"Cache";i:1;s:9:"checkFile";}i:1;s:84:"/home/insitu/public_html/salon/document_root/../app/templates/Reports/payrolls.phtml";i:2;i:1276920425;}}}?><?php
// file …/templates/Reports/payrolls.phtml
//

$_cb = LatteMacros::initRuntime($template, NULL, 'c134bfc381'); unset($_extends);


//
// block content
//
if (!function_exists($_cb->blocks['content'][] = '_cbb5218a3a61e_content')) { function _cbb5218a3a61e_content() { extract(func_get_arg(0))
;if (SnippetHelper::$outputAllowed) { LatteMacros::includeTemplate("../Checkout/find-user.phtml", $template->getParams(), $_cb->templates['c134bfc381'])->render() ?>
...
<?php LatteMacros::includeTemplate('navigation.phtml', $template->getParams(), $_cb->templates['c134bfc381'])->render() ?>
