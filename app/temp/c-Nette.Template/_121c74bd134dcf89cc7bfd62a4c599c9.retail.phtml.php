<?php //netteCache[01]000239a:2:{s:4:"time";s:21:"0.98118100 1303430756";s:9:"callbacks";a:1:{i:0;a:3:{i:0;a:2:{i:0;s:5:"Cache";i:1;s:9:"checkFile";}i:1;s:84:"/home/cpbeauty/public_html/salon/document_root/../app/templates/Reports/retail.phtml";i:2;i:1276920425;}}}?><?php
// file …/templates/Reports/retail.phtml
//

$_cb = LatteMacros::initRuntime($template, NULL, 'f5c42d9156'); unset($_extends);


//
// block content
//
if (!function_exists($_cb->blocks['content'][] = '_cbb483ff5629b_content')) { function _cbb483ff5629b_content() { extract(func_get_arg(0))
;if (SnippetHelper::$outputAllowed) { LatteMacros::includeTemplate("../Checkout/find-user.phtml", $template->getParams(), $_cb->templates['f5c42d9156'])->render() ?>
...
<?php LatteMacros::includeTemplate('navigation.phtml', $template->getParams(), $_cb->templates['f5c42d9156'])->render() ?>
