<?php //netteCache[01]000247a:2:{s:4:"time";s:21:"0.46203000 1311851060";s:9:"callbacks";a:1:{i:0;a:3:{i:0;a:2:{i:0;s:5:"Cache";i:1;s:9:"checkFile";}i:1;s:92:"/srv/www/bloom.getmochi.com/public_html/document_root/../app/templates/Checkout/search.phtml";i:2;i:1311820097;}}}?><?php
// file …/templates/Checkout/search.phtml
//

$_cb = LatteMacros::initRuntime($template, NULL, '479d03ad75'); unset($_extends);


//
// block content
//
if (!function_exists($_cb->blocks['content'][] = '_cbb7123d704d3_content')) { function _cbb7123d704d3_content() { extract(func_get_arg(0))
;if (SnippetHelper::$outputAllowed) { LatteMacros::includeTemplate("../Checkout/find-user.phtml", $template->getParams(), $_cb->templates['479d03ad75'])->render() ?>
