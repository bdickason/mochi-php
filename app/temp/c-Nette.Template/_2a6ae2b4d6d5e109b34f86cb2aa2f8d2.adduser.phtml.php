<?php //netteCache[01]000247a:2:{s:4:"time";s:21:"0.72171200 1312058544";s:9:"callbacks";a:1:{i:0;a:3:{i:0;a:2:{i:0;s:5:"Cache";i:1;s:9:"checkFile";}i:1;s:92:"/srv/www/bloom.getmochi.com/public_html/document_root/../app/templates/Profile/adduser.phtml";i:2;i:1311820098;}}}?><?php
// file …/templates/Profile/adduser.phtml
//

$_cb = LatteMacros::initRuntime($template, NULL, '035c74bfe4'); unset($_extends);


//
// block content
//
if (!function_exists($_cb->blocks['content'][] = '_cbbf8b909351e_content')) { function _cbbf8b909351e_content() { extract(func_get_arg(0))
;LatteMacros::includeTemplate("../Checkout/find-user.phtml", $template->getParams(), $_cb->templates['035c74bfe4'])->render() ?>
