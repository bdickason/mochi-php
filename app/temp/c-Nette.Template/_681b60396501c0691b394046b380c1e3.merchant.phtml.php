<?php //netteCache[01]000248a:2:{s:4:"time";s:21:"0.62059800 1311895620";s:9:"callbacks";a:1:{i:0;a:3:{i:0;a:2:{i:0;s:5:"Cache";i:1;s:9:"checkFile";}i:1;s:93:"/srv/www/bloom.getmochi.com/public_html/document_root/../app/templates/Reports/merchant.phtml";i:2;i:1311820099;}}}?><?php
// file …/templates/Reports/merchant.phtml
//

$_cb = LatteMacros::initRuntime($template, NULL, '6fd4d4718d'); unset($_extends);


//
// block content
//
if (!function_exists($_cb->blocks['content'][] = '_cbb39b436fee8_content')) { function _cbb39b436fee8_content() { extract(func_get_arg(0))
;if (SnippetHelper::$outputAllowed) { LatteMacros::includeTemplate("../Checkout/find-user.phtml", $template->getParams(), $_cb->templates['6fd4d4718d'])->render() ?>
...
<?php LatteMacros::includeTemplate('navigation.phtml', $template->getParams(), $_cb->templates['6fd4d4718d'])->render() ?>
