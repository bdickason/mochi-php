<?php //netteCache[01]000238a:2:{s:4:"time";s:21:"0.69714300 1276970589";s:9:"callbacks";a:1:{i:0;a:3:{i:0;a:2:{i:0;s:5:"Cache";i:1;s:9:"checkFile";}i:1;s:83:"/home/insitu/public_html/salon/document_root/../app/templates/Checkout/search.phtml";i:2;i:1276920425;}}}?><?php
// file …/templates/Checkout/search.phtml
//

$_cb = LatteMacros::initRuntime($template, NULL, 'ff007e1f7c'); unset($_extends);


//
// block content
//
if (!function_exists($_cb->blocks['content'][] = '_cbb86c1114bf8_content')) { function _cbb86c1114bf8_content() { extract(func_get_arg(0))
;if (SnippetHelper::$outputAllowed) { LatteMacros::includeTemplate("../Checkout/find-user.phtml", $template->getParams(), $_cb->templates['ff007e1f7c'])->render() ?>
