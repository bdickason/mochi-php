<?php //netteCache[01]000235a:2:{s:4:"time";s:21:"0.32580300 1276921777";s:9:"callbacks";a:1:{i:0;a:3:{i:0;a:2:{i:0;s:5:"Cache";i:1;s:9:"checkFile";}i:1;s:80:"/home/insitu/public_html/salon/document_root/../app/templates/Profile/list.phtml";i:2;i:1276920425;}}}?><?php
// file …/templates/Profile/list.phtml
//

$_cb = LatteMacros::initRuntime($template, NULL, '10b0fa6dcd'); unset($_extends);


//
// block content
//
if (!function_exists($_cb->blocks['content'][] = '_cbbec5c7f699e_content')) { function _cbbec5c7f699e_content() { extract(func_get_arg(0))
;LatteMacros::includeTemplate("../Checkout/find-user.phtml", $template->getParams(), $_cb->templates['10b0fa6dcd'])->render() ?>
