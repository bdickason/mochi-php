<?php //netteCache[01]000238a:2:{s:4:"time";s:21:"0.90995600 1276921393";s:9:"callbacks";a:1:{i:0;a:3:{i:0;a:2:{i:0;s:5:"Cache";i:1;s:9:"checkFile";}i:1;s:83:"/home/insitu/public_html/salon/document_root/../app/templates/Default/default.phtml";i:2;i:1276920425;}}}?><?php
// file …/templates/Default/default.phtml
//

$_cb = LatteMacros::initRuntime($template, NULL, 'dbc69cfa4b'); unset($_extends);


//
// block content
//
if (!function_exists($_cb->blocks['content'][] = '_cbb0c1a3a0c6f_content')) { function _cbb0c1a3a0c6f_content() { extract(func_get_arg(0))
;LatteMacros::includeTemplate("../Checkout/find-user.phtml", $template->getParams(), $_cb->templates['dbc69cfa4b'])->render() ?>
