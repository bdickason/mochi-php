<?php //netteCache[01]000246a:2:{s:4:"time";s:21:"0.36833300 1315439600";s:9:"callbacks";a:1:{i:0;a:3:{i:0;a:2:{i:0;s:5:"Cache";i:1;s:9:"checkFile";}i:1;s:91:"/srv/www/bloom.getmochi.com/public_html/document_root/../app/templates/Reports/retail.phtml";i:2;i:1311820100;}}}?><?php
// file …/templates/Reports/retail.phtml
//

$_cb = LatteMacros::initRuntime($template, NULL, 'eab7c8513c'); unset($_extends);


//
// block content
//
if (!function_exists($_cb->blocks['content'][] = '_cbbbdb6256fbc_content')) { function _cbbbdb6256fbc_content() { extract(func_get_arg(0))
;if (SnippetHelper::$outputAllowed) { LatteMacros::includeTemplate("../Checkout/find-user.phtml", $template->getParams(), $_cb->templates['eab7c8513c'])->render() ?>
...
<?php LatteMacros::includeTemplate('navigation.phtml', $template->getParams(), $_cb->templates['eab7c8513c'])->render() ?>
