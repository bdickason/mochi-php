<?php //netteCache[01]000238a:2:{s:4:"time";s:21:"0.74590700 1303002077";s:9:"callbacks";a:1:{i:0;a:3:{i:0;a:2:{i:0;s:5:"Cache";i:1;s:9:"checkFile";}i:1;s:83:"/home/cpbeauty/public_html/salon/document_root/../app/templates/Reports/daily.phtml";i:2;i:1276920425;}}}?><?php
// file …/templates/Reports/daily.phtml
//

$_cb = LatteMacros::initRuntime($template, NULL, '3e239efafc'); unset($_extends);


//
// block content
//
if (!function_exists($_cb->blocks['content'][] = '_cbba0c1f7aef2_content')) { function _cbba0c1f7aef2_content() { extract(func_get_arg(0))
;if (SnippetHelper::$outputAllowed) { LatteMacros::includeTemplate("../Checkout/find-user.phtml", $template->getParams(), $_cb->templates['3e239efafc'])->render() ?>
...
<?php LatteMacros::includeTemplate('navigation.phtml', $template->getParams(), $_cb->templates['3e239efafc'])->render() ?>
