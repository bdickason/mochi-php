<?php //netteCache[01]000240a:2:{s:4:"time";s:21:"0.35896200 1303000478";s:9:"callbacks";a:1:{i:0;a:3:{i:0;a:2:{i:0;s:5:"Cache";i:1;s:9:"checkFile";}i:1;s:85:"/home/cpbeauty/public_html/salon/document_root/../app/templates/Default/default.phtml";i:2;i:1276920425;}}}?><?php
// file …/templates/Default/default.phtml
//

$_cb = LatteMacros::initRuntime($template, NULL, '558be7a36c'); unset($_extends);


//
// block content
//
if (!function_exists($_cb->blocks['content'][] = '_cbbcbaec42505_content')) { function _cbbcbaec42505_content() { extract(func_get_arg(0))
;LatteMacros::includeTemplate("../Checkout/find-user.phtml", $template->getParams(), $_cb->templates['558be7a36c'])->render() ?>
