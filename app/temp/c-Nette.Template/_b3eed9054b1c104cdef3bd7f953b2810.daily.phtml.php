<?php //netteCache[01]000236a:2:{s:4:"time";s:21:"0.73125300 1276969863";s:9:"callbacks";a:1:{i:0;a:3:{i:0;a:2:{i:0;s:5:"Cache";i:1;s:9:"checkFile";}i:1;s:81:"/home/insitu/public_html/salon/document_root/../app/templates/Reports/daily.phtml";i:2;i:1276920425;}}}?><?php
// file …/templates/Reports/daily.phtml
//

$_cb = LatteMacros::initRuntime($template, NULL, 'aa86c46347'); unset($_extends);


//
// block content
//
if (!function_exists($_cb->blocks['content'][] = '_cbb6722e6d374_content')) { function _cbb6722e6d374_content() { extract(func_get_arg(0))
;if (SnippetHelper::$outputAllowed) { LatteMacros::includeTemplate("../Checkout/find-user.phtml", $template->getParams(), $_cb->templates['aa86c46347'])->render() ?>
...
<?php LatteMacros::includeTemplate('navigation.phtml', $template->getParams(), $_cb->templates['aa86c46347'])->render() ?>
