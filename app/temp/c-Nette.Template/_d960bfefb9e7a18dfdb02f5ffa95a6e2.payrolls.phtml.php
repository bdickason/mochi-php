<?php //netteCache[01]000248a:2:{s:4:"time";s:21:"0.96153500 1312299092";s:9:"callbacks";a:1:{i:0;a:3:{i:0;a:2:{i:0;s:5:"Cache";i:1;s:9:"checkFile";}i:1;s:93:"/srv/www/bloom.getmochi.com/public_html/document_root/../app/templates/Reports/payrolls.phtml";i:2;i:1311820099;}}}?><?php
// file …/templates/Reports/payrolls.phtml
//

$_cb = LatteMacros::initRuntime($template, NULL, '966f587a39'); unset($_extends);


//
// block content
//
if (!function_exists($_cb->blocks['content'][] = '_cbb3a463e88a5_content')) { function _cbb3a463e88a5_content() { extract(func_get_arg(0))
;if (SnippetHelper::$outputAllowed) { LatteMacros::includeTemplate("../Checkout/find-user.phtml", $template->getParams(), $_cb->templates['966f587a39'])->render() ?>
...
<?php LatteMacros::includeTemplate('navigation.phtml', $template->getParams(), $_cb->templates['966f587a39'])->render() ?>
