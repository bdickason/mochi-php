<?php //netteCache[01]000239a:2:{s:4:"time";s:21:"0.74234400 1276920527";s:9:"callbacks";a:1:{i:0;a:3:{i:0;a:2:{i:0;s:5:"Cache";i:1;s:9:"checkFile";}i:1;s:84:"/home/insitu/public_html/salon-new/document_root/../app/templates//@layout-new.phtml";i:2;i:1276920425;}}}?><?php
// file …/templates//@layout-new.phtml
//

$_cb = LatteMacros::initRuntime($template, NULL, '0be10ebfd8'); unset($_extends);
...
<div class="container">
    	...
    	<div class="adminBar">
        	<div class="busName"><p><a href="<?php echo TemplateHelpers::escapeHtml($control->link("Default:default")) ?>" title="Go To Home Page">Get <strong>Mochi</strong></a></p></div>
<?php if (isset($user)): ?>
...
<?php LatteMacros::includeTemplate("Checkout/find-user.phtml", $template->getParams(), $_cb->templates['0be10ebfd8'])->render() ?>
