...
function __shell_default_error_handler($errno, $errstr, $errfile, $errline, $errctx) {
	...
	//Nette has a hardcoded call to this function
	//its deprecated in PHP 5.3 and PHP cries
	if (strpos($errstr, 'set_magic_quotes_runtime') !== 0)
	{
		return;
	}
...
Welcome to Mochi shell!
>> use '?' to open the inline help 

EOF;

require_once('../app/bootstrap-shell.php');
